...
describe("Player Controller", () => {
  ...
  describe("getPlayers", () => {
    ...
    it("should handle errors", async () => {
      (Player.findAll as jest.Mock).mockRejectedValue(
  ...
  describe("getPlayerById", () => {
    it("should return a player when found", async () => {
      ...
      (PlayerCacheService.prototype
        .getPlayerByIdAndUpdate as jest.Mock).mockResolvedValue(mockPlayer);
    ...
    it("should return 404 when player is not found", async () => {
      (PlayerCacheService.prototype
        .getPlayerByIdAndUpdate as jest.Mock).mockResolvedValue(null);
